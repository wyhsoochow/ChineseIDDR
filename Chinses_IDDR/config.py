...
class Config(object):
    def __init__(self, classnum=4, splitting=3):
        self.i2sense = [
        ...
        self.binclass = 3        # 0, 1, 2, 3 self.senseclass2i

        self.wordvec_path = '/home/yhwu/IDDR/data/glove.840B.300d.txt'
        self.wordvec_dim = 300
        self.max_sent_len = 100
        ###############################################################################
        # projection
        self.gate_type = "llll"#neural-gate
        self.merge_option = "att-gate"
        ################################################################################
        # attention
        self.attn_topk = 1
        self.attn_dropout = 0
        ...
        self.elmo_options = '/home/qtxue/AMR_Deep_Enhanced_Repr/data/elmo_2x4096_512_2048cnn_2xhighway_options.json'
        self.elmo_weights = '/home/qtxue/AMR_Deep_Enhanced_Repr/data/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5'
        self.elmo_dropout = 0
        ...
        self.logdir = './res/' + datetime.now().strftime('%B%d')#'%B%d-%H:%M:%S'
